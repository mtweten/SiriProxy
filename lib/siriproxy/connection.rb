...
class SiriProxy::Connection < EventMachine::Connection
  ...
  def prep_received_object(object)
    ...
    # Copied from https://github.com/plamoni/SiriProxy/issues/143
    # Fix is not necessarily "official" - I don't currently know enough about how siriproxy works to comment on what this does
